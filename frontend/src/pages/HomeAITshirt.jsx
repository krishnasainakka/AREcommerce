...
const HomeAITshirt = () => {
    ...
    return (
        <AnimatePresence>
            {snap.intro && (
                <motion.section className='home-ai-tshirt' {...slideAnimation('left')}>
                    <motion.header {...slideAnimation("down")}>
                        <img src="./threejs.png" alt="logo" className='w-8 h-8 object-contain' />
                    </motion.header>
                    <motion.div className='home-content-ai-tshirt' {...headContainerAnimation}>
                        <motion.div {...headTextAnimation}>
                            <h1 className='head-text-ai-tshirt'>LET'S <br className="xl:block hidden" /> DO IT.</h1>
                        </motion.div>
